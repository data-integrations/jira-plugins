 ...
 */
public class JiraInputFormatProvider implements InputFormatProvider {
  public static final String PROPERTY_CONFIG_JSON = "cdap.jira.config";
  ...
  public String getInputFormatClassName() {
    return JiraInputFormat.class.getName();
  }
